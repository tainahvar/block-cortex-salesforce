    ...
    <div style="background-color: #FFFFFF; height:525px;width:100%"></div>
      <div style="background-color: #FFFFFF; border: solid 1px #4285F4; border-radius: 5px; padding: 5px 10px; height: 60px; width:100%">
        <nav style="font-size: 18px; color: #4285F4">
          <a style="padding: 5px; float: center; line-height: 40px; margin-left: 8px; color: #4285F4" href="/embed/dashboards/cortex_salesforce::case_overview__trends?Origin={{_filters['case_management.origin']}}" target=”_self”>Case Overview And Trends</a>
          <a style="padding: 5px; float: center; line-height: 40px; margin-left: 8px; color: #4285F4" href="/embed/dashboards/cortex_salesforce::case_management__resolution?Origin={{_filters['case_management.origin']}}" target=”_self”>Case Management And Resolution</a>
          <a style="padding: 5px; float: center; line-height: 40px; margin-left: 8px; color: #4285F4" href="/embed/dashboards/cortex_salesforce::accounts_with_cases?Origin={{_filters['case_management.origin']}}" target=”_self”>Accounts With Cases</a>
        </nav>
        </nav>
      </div>
